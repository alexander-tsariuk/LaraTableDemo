...
(function ($) {
  ...
  var DefaultWhitelist = {
    ...
    a: ['target', 'href', 'title', 'rel', 'data-page'],
    area: [],
    b: [],
    br: [],
    col: [],
  ...
  Selectpicker.prototype = {
    ...
    createView: function (isSearching, setSize, refresh) {
      ...
      function scroll (scrollTop, init) {
        if (!that.selectpicker.current.elements) {
    ...
    render: function () {
      ...
      if (this.options.selectedTextFormat === 'static') {
        ...
        showCount = this.multiple && this.options.selectedTextFormat.indexOf('count') !== -1;
    ...
    setMenuSize: function (isAuto) {
      ...
      if (this.options.dropupAuto) {
        ...
        if (!this.selectpicker.current.elements) {
    ...
    clickListener: function () {
      ...
      this.$menuInner.on('click', 'li a', function (e, retainActive) {
		var el = $(this);
		if (el.parents('.btns').length) {
			return;
		}
		var p = el.parents('.select-link');
		if (p.length) {
			var inp = $('input[name="'+p.data('target')+'"]');
			var text = el.text() + ' ';
			if (el.hasClass('selected')) {
				var val = inp.val().replace(text, '');
			} else {
				var val = inp.val() + text;
			}
			inp.val(val);
    ...
    liveSearchListener: function () {
      ...
      this.$searchbox.on('input propertychange', function () {
        ...
        if (searchValue) {
          ...
          if (!searchMatch.length && !that.$element.data('url')) {
