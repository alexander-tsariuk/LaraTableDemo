...
class ChangeDataBulkAction extends AbstractBulkAction
{
    ...
    public function render(): View
    {
        ...
        $action = route($model->getRoute() . '.bulkedit');
        return view('laravel-table::' . config('laravel-table.ui') . '.editdata-bulk-action', [
            'bulkAction' => $this,
